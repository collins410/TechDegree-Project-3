...
// Set the payment menu to the credit card by default
...
$('button').click(function(e){
  ...
  if ((ccValid === true) && (totalValid === true) && (zipValid === true) && (cvvValid === true) && (nameValid === true) && (emailValid === true) ) {
    alert('submit button was clicked and form validation was completed successfully');
